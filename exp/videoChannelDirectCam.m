function videoChannelDirectCam(pairNo, labName, devID)
%% Function for video-mediated interaction across Mordor and Gondor labs
%
% USAGE: videoChannelDirectCam(pairNo, labName, devID='/dev/video0')
%
% Reads in video frames from a v4l2 video device and displays them on 
% screen as fast as it can. A custom GStreamer pipeline is called via Psychtoolbox,

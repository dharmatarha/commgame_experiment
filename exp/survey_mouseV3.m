function [selects] = survey_mouseV3(pairNo, labName, quest_type, gameNo)
% The full course of an experiment

%clearvars;
%rng('shuffle');

% Add questionnaire folder and all its sub-folders
addpath(genpath(['/home/mordor/CommGame/PTB_Questionnaire_scriptsV3/..']));
...
save('-v7', surveyDataFile, 'selects');

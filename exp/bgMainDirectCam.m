function bgMainDirectCam(pairNo, player, labName, roundNo, tokenNo, confType, confNo, strangeImgNo, devID)
%% Bargaining Game main experiment
%
% USAGE: bgMainDirectCam(pairNo, player, labName, roundNo, tokenNo, confType,... 
